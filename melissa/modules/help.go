...
import (
	...
	"github.com/famhawiteinfosys/melissa/melissa/utils/helpers"
	log "github.com/sirupsen/logrus"

	"github.com/famhawiteinfosys/melissa/melissa/config"
	"github.com/famhawiteinfosys/melissa/melissa/db"
	"github.com/famhawiteinfosys/melissa/melissa/i18n"

	"github.com/famhawiteinfosys/melissa/melissa/utils/string_handling"
)
...
const (
	aboutText = "Info & About\n\nHere are some of the FAQs about melissa."
	startHelp = "Hey there! My name is melissa [✨ ](https://i.ibb.co/PDvVQkm/melissa-pgp.jpg)\n" +
		"I'm here to help you manage your groups!\n" +
		"Hit /help to find out more about how to use me to my full potential.\n" +
		"Join my <a href='https://t.me/dMelissaBotUpdates'>News Channel</a> to get information on all the latest updates."
	mainhlp = "Hey %s!\n" +
		"My name is melissa [✨ ](https://i.ibb.co/PDvVQkm/melissa-pgp.jpg)\n\n" +
	...
	aboutKb = gotgbot.InlineKeyboardMarkup{
		InlineKeyboard: [][]gotgbot.InlineKeyboardButton{
			...
			},
			{
				{
					Text: "News Channel 📢",
					Url:  "https://t.me/dMelissaBotUpdates",
				},
				{
					Text: "Support Group 👥",
					Url:  "https://t.me/famhawiteinfosysSupport",
				},
			},
			{
				{
	...
	startMarkup = gotgbot.InlineKeyboardMarkup{
		InlineKeyboard: [][]gotgbot.InlineKeyboardButton{
			...
			},
			{
				{
					Text: "➕ Add me to chat!",
					Url:  "https://t.me/melissa?startgroup=botstart",
				},
				{
					Text: "Support Group 👥",
					Url:  "https://t.me/famhawiteinfosysSupport",
